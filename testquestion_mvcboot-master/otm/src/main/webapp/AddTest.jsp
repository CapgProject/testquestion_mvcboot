...
<link href='<c:url value = "/webjars/img/apple-touch-icon.png"/>'
...
<!-- Bootstrap CSS File -->
<link
	href='<c:url value = "/webjars/lib/bootstrap/css/bootstrap.min.css"/>'
	rel="stylesheet">

<!-- Libraries CSS Files -->
<link
	href='<c:url value = "/webjars/lib/font-awesome/css/font-awesome.min.css"/>'
	rel="stylesheet">
<link href='<c:url value = "/webjars/lib/animate/animate.min.css"/>'
	rel="stylesheet">
			...
			<fo:form id="testform" action="addtestsubmit" method="post"
				...
				<div class="row">
					<div class="text-center col-md-6 col-lg-6">Enter the Test
						Duration:</div>
					<div class="col-md-4 col-lg-4">
						<fo:input type="time" path="testDuration" placeholder="(HH:MM:SS)"
				...
				<div class="row">
					<div class="text-center col-md-6 col-lg-6">Enter the Test
						Start time:</div>
					<div class="col-md-4 col-lg-4">
						<fo:input type="datetime-local" path="startTime"
				...
				<div class="row">
					<div class="text-center    col-md-6 col-lg-6">Enter the Test
						End time:</div>
					<div class="col-md-4 col-lg-4">
						<fo:input type="datetime-local" path="endTime"
